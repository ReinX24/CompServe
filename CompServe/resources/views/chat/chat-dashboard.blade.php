    ...
    <div class="container mx-auto px-4 md:px-6 py-6">
        ...
        <div class="overflow-x-auto">
            <ul id="conversations-list"
                class="menu rounded-box w-full shadow-lg">
                @foreach ($users as $user)
                    <li id="conversation-{{ $user->id }}"
                        data-user-id="{{ $user->id }}">
                        <a href="{{ route('chat.show', $user->id) }}"
                            class="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-base-100 hover:bg-base-200 text-neutral rounded-lg transition gap-2 sm:gap-0 mb-2">
...
<x-layouts.app>
    <div class="breadcrumbs text-sm mb-4">
        <ul class="text-base-content/70">
            ...
            <li class="text-primary font-semibold">Chats</li>
        </ul>
    </div>
