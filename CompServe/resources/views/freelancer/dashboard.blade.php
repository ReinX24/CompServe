        ...
        <a href="{{ route('freelancer.jobs.applied') }}">
            <div
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div
                        class="bg-green-100 dark:bg-green-900 p-3 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="{{ route('freelancer.jobs.current') }}">
            <div
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div
                        class="bg-purple-100 dark:bg-purple-900 p-3 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="{{ route('freelancer.jobs.finished') }}">
            <div
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div
                        class="bg-orange-100 dark:bg-orange-900 p-3 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg"
