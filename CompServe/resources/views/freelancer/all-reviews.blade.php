<x-layouts.app>
    ...
    <div
        class="relative overflow-hidden bg-linear-to-br from-warning/10 via-secondary/5 to-accent/10 rounded-xl sm:rounded-2xl shadow-xl mb-6 sm:mb-8 border border-base-300/50">
        <!-- Decorative Background Pattern -->
        <div class="absolute inset-0 opacity-5">
            <div
                class="absolute top-0 left-0 w-32 h-32 sm:w-40 sm:h-40 bg-warning rounded-full blur-3xl">
            </div>
            <div
            ...
            <div class="flex flex-col gap-5 sm:gap-6">
                <div class="flex-1">
                    <h1
                        ...
                        <span class="leading-tight">My Reviews</span>
                    </h1>
                    <p
                    ...
                    <div class="grid grid-cols-3 sm:flex sm:flex-wrap gap-3 sm:gap-6 mt-5 sm:mt-6">
                        <div class="flex flex-col sm:flex-row items-center sm:items-center gap-1 sm:gap-2">
                            ...
                            <div class="text-center sm:text-left">
                                ...
                                <p class="text-xs text-base-content/60 mt-0.5">Average</p>
                            </div>
                        </div>
                        <div class="flex flex-col sm:flex-row items-center sm:items-center gap-1 sm:gap-2">
                            <div
                            ...
                            <div class="text-center sm:text-left">
                                <p class="text-xl sm:text-2xl font-bold text-base-content leading-none">
                                    {{ $fiveStarReviews }}</p>
                                <p class="text-xs text-base-content/60 mt-0.5">5-Star</p>
                            </div>
                        </div>
                        <div class="flex flex-col sm:flex-row items-center sm:items-center gap-1 sm:gap-2">
                            <div
                ...
                <!-- Rating Distribution Visual - Responsive -->
                <div
                    class="bg-base-100/80 backdrop-blur-sm rounded-xl p-4 sm:p-6 shadow-lg w-full sm:w-auto sm:shrink-0">
                    <div class="text-center">
                        <div class="text-4xl sm:text-5xl font-bold text-warning mb-2">
                        ...
                        <p class="text-xs text-base-content/60">Based on
                            {{ $totalReviews }} <span class="hidden xs:inline">reviews</span></p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div
                        ...
                        <div class="card-body p-4 sm:p-6">
                            ...
                            <div class="flex items-center justify-between mb-3 sm:mb-4 gap-2">
                                    ...
                                    @for ($i = 1; $i <= 5; $i++)
                                        ...
                                        @else
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                stroke-width="1.5"
                                                stroke="currentColor"
                                                class="w-5 h-5 sm:w-6 sm:h-6 text-base-300">
                                                <path stroke-linecap="round"
                                                    stroke-linejoin="round"
                                ...
                                <div
                                    class="badge badge-warning sm:badge-lg font-bold text-xs sm:text-sm shrink-0">
                                    {{ $review->rating }}/5</div>
                            </div>

                            <!-- Job Title with Icon -->
                            <h2
                                class="card-title text-base sm:text-xl mb-2 sm:mb-3 flex items-start gap-2">
                            ...
                            <div
                                class="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4 p-2 sm:p-3 bg-base-200 rounded-lg">
                                <div class="avatar avatar-placeholder">
                                    <div
                                        class="bg-secondary text-secondary-content rounded-full w-8 sm:w-10">
                                        <span
                                            class="text-xs sm:text-sm">{{ substr($review->client->name ?? 'U', 0, 1) }}</span>
                                    </div>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <p class="text-xs text-base-content/60">
                                        Reviewed by</p>
                                    <p class="font-semibold truncate text-sm sm:text-base">
                            ...
                            <!-- Review Comments -->
                            <div class="bg-base-200 rounded-lg p-3 sm:p-4 mb-3 sm:mb-4">
                            ...
                            <!-- Footer with Date -->
                            <div
                                class="flex flex-col xs:flex-row xs:items-center xs:justify-between gap-2 text-xs text-base-content/60 pt-2 border-t border-base-300">
            ...
            <div
                ...
                <div class="relative">
                    ...
                    <a href="{{ route('freelancer.gigs.index') }}"
                        ...
                        <span class="hidden xs:inline">Browse Available Jobs</span>
                        <span class="xs:hidden">Browse Jobs</span>
                    </a>
                </div>
            </div>
        </div>
