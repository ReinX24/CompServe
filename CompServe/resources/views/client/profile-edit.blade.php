            ...
            <div class="relative p-6 md:p-8">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-base-content/70 mt-1">Update your personal information and social links</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="form-control md:col-span-2">
                                <label class="label">
                                    ...
                                    <span class="label-text-alt text-base-content/60">Tell us about yourself</span>
                                </label>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="form-control">
                                <label class="label">
                                    <span class="label-text font-semibold flex items-center gap-2">
                                        <svg class="h-4 w-4 text-[#E4405F]" fill="currentColor" viewBox="0 0 24 24">
